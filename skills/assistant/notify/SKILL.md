...
```bash
node /app/.pi/skills/assistant/notify/scripts/notify.mjs "your message here"
```

**A file** (document, image, generated report, etc. — optional caption):

```bash
node /app/.pi/skills/assistant/notify/scripts/send-file.mjs "/app/storage/artefacts/report.md" "your daily report"
```
