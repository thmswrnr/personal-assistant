...
```bash
node /app/.pi/skills/assistant/schedule/scripts/schedule.mjs list

# cron = 5 fields: minute hour day-of-month month day-of-week (local time)
node /app/.pi/skills/assistant/schedule/scripts/schedule.mjs add \
  --label "Morning briefing" --cron "0 7 * * *" --prompt "/skill:morning-briefing"

node /app/.pi/skills/assistant/schedule/scripts/schedule.mjs remove --label "Morning briefing"
```
